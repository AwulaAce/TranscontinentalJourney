...
export default function Home() {
  return (
    <div className="relative bg-gray-900 text-gray-50">
      ...
      <iframe width="560" height="315" src="https://www.youtube.com/embed/wjiUzG9vKZI?si=NofpfY_C4GEjvCHi" title="YouTube video player" 
      ...
      >
        ...
        <img
          ...
          alt="Spintex Knights basketball training in Ghana"
          className="w-full h-96 object-cover rounded-lg"
        />
        ...
        <img
          src="https://images.pexels.com/photos/2820902/pexels-photo-2820902.jpeg"
          alt="Spintex Knights basketball competition"
          className="w-full h-96 object-cover rounded-lg"
        />
      </motion.section>
      </div>
